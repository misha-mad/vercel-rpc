...
>
	...
	<FeatureRow title="Auto-generated client" reverse>
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['autoClient']}
			/>{/snippet}
	...
	<FeatureRow title="Watch mode">
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['watchMode']}
			/>{/snippet}
	...
	<FeatureRow title="Macro-driven" reverse>
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['macroDriven']}
			/>{/snippet}
	...
	<FeatureRow title="Init & state injection">
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['initState']}
			/>{/snippet}
	...
	<FeatureRow title="Edge caching">
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['edgeCache']}
			/>{/snippet}
	...
	<FeatureRow title="Vercel-native" reverse>
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['vercelNative']}
			/>{/snippet}
	...
	<FeatureRow title="4 framework wrappers">
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['frameworks']}
			/>{/snippet}
	...
	<FeatureRow title="Rich client" reverse>
		{#snippet code()}<CodeBlock
				showToolbar={false}
				html={data.highlighted['richClient']}
			/>{/snippet}
