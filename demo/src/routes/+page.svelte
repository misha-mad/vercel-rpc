...
>
	<img
		src="/hero-left.png"
		alt=""
		class="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 h-[150%] object-contain invert opacity-70 hidden sm:block"
	/>
	<img
		src="/hero-right.png"
		alt=""
		class="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 h-[150%] object-contain invert opacity-70 hidden sm:block"
	/>
