...
<svelte:head>
	<title>Field Naming — metaxy</title>
</svelte:head>
...
<div class="max-w-3xl space-y-8">
	...
	<p class="text-text-muted leading-relaxed text-sm">
		...
		<a href="/docs/codegen/serde" class="text-accent-ts hover:underline"><code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">serde(rename)</code></a> &gt;
		container
		<a href="/docs/codegen/serde" class="text-accent-ts hover:underline"><code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">rename_all</code></a> &gt;
