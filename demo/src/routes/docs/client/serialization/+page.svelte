...
<div class="max-w-3xl space-y-8">
	...
	<p class="text-text-muted leading-relaxed">
		...
		<code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">deserialize</code> to use a
		custom serialization format instead of plain JSON.
	</p>

	<h2 class="text-xl font-semibold">Default</h2>
	<p class="text-text-muted text-sm mb-2">
		When not specified, the client uses <code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">JSON.stringify</code>
	...
	<p class="text-text-muted text-sm mb-2">
		Use a library like <code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">superjson</code>
		...
		<code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">Set</code> and other types
