...
<div class="max-w-3xl space-y-8">
	...
	<p class="text-text-muted leading-relaxed">
		Set a global timeout for all requests, pass an <code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">AbortSignal</code>
		...
		<code class="bg-bg-code px-1.5 py-0.5 rounded text-xs font-mono">name: 'AbortError'</code>,
	...
	<p class="text-text-muted text-sm mb-2">
		When both client and per-call signals are provided, they are combined — the request aborts
