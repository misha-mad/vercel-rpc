...
export type { Procedures, CachedTimePrivateResponse, CachedTimeResponse, CachedTimeStaleResponse, EchoInput, EchoOutput, MathInput, MathResult, ServiceStatus, Stats, TimeResponse, TypeShowcase, UserProfile, EventKind, HealthStatus, Operation, UserRole };
...
const VOID_QUERIES: Set<string> = new Set(["cached_time", "cached_time_private", "cached_time_stale", "secret", "status", "time"]);
