...
const VOID_QUERIES: Set<string> = new Set(["bigint_demo", "cached_time", "cached_time_private", "cached_time_stale", "cookie_demo", "dedup_demo", "init_demo", "secret", "time", "types"]);
...
export interface RpcClient {
   ...
   */
  stream(key: "countdown", input: CountdownInput): AsyncGenerator<CountdownTick>;
  stream(key: "countdown", input: CountdownInput, options: CallOptions): AsyncGenerator<CountdownTick>;
  /**
   ...
   */
  stream(key: "token_stream", input: TokenStreamInput): AsyncGenerator<Token>;
  stream(key: "token_stream", input: TokenStreamInput, options: CallOptions): AsyncGenerator<Token>;
}
